...
layer, and a telemetry dual-pipe. By defining capabilities as abstract traits,
it enforces clean architectural boundaries, maximizes testability through mock
implementations, and ensures consistent data contracts across the entire native
ecosystem.
