...
export type Tagged<E extends string, R extends Record<string, unknown> = Record<string, unknown>> = {
	readonly type: E;
	readonly cause?: unknown;
} & R;

export const makeError = <E extends string, R extends Record<string, unknown> = Record<string, unknown>>(
	type: E,
...
export type StateLockPoisoned = Tagged<"StateLockPoisoned", { context: string }>;
