...
impl UnifiedRequest {
	...
	pub fn Priority(&self) -> Option<u32> { self.Metadata.get("priority").and_then(|Value| Value.parse().ok()) }
...
mod tests {
	...
	fn TestUnifiedRequestBuilder() {
		let Request = UnifiedRequest::New("fileSystem.readFile")
			...
			.WithTimeout(5000)
			.WithPriority(10)
			.WithMetadata("traceparent", "00-0af7651916cd43dd8448eb211c80319c-b7ad6b7169203331-01")
