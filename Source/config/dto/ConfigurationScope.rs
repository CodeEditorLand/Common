...
/// @description Defines the Data Transfer Object enum for representing the
/// scope at which a configuration setting can be applied.
use serde::{Deserialize, Serialize};

/// An enum that describes the scope of a configuration value, as defined in an
/// extension's `package.json`. This determines where the setting can be
/// configured (e.g., in User settings, Workspace settings, etc.).
///
